...
window.DEFAULT_APP_CONFIG = {
    ...
    // ── Nội dung lá thư ─────────────────────────────────────────────
    letter: {
        text: "Chúc mừng ngày 8/3 Vĩ Cầm xinh đẹp!\n\n Chúc Cầm 3 đừng, 3 không, 3 nhớ. \n\n Đừng buồn vì những chuyện không vui, đừng quá khắt khe với bản thân và đừng nghĩ rằng chỉ có một mình. \n\n Không cảm tháy cô đơn, không áp lực quá nhiều và không một mình gánh cả thế giới. \n\n Nhớ luôn yêu thương bản thân, nhớ luôn giữ nụ cười trên môi và nhớ là có một người đáng yêu đang chờ em.\n\n Yêu Cầm nhiều lắm!",
        image: '',
        caption: '♥'
    },
